...
for ii = 1:m
    switch fil{ii,1}
        ...
        case 'E_sample'          % sample modulus, E_sample
            GoodR = FR([FR.E_sample] >= fil{ii,2}(1) & [FR.E_sample] <= fil{ii,2}(2));
        ...
        case 'h_change'         % nomralized displacemnt between the start of the zero-point segment and the first positive point after the zero-point correction is applied
            GoodR = FR([FR.h_change] >= fil{ii,2}(1) & [FR.h_change] <= fil{ii,2}(2));
        case 'p_change'         % nomralized load between the start of the zero-point segment and the first positive point after the zero-point correction is applied
